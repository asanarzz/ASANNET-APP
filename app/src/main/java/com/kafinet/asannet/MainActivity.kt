...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val categories = listOf(
            ...
            CategoryEntry(ContentType.FILE, getString(R.string.cat_file), R.drawable.ic_file, 0),
            ...
            CategoryEntry(ContentType.SOFTWARE, getString(R.string.cat_software), R.drawable.ic_software, 0),
            CategoryEntry(ContentType.MUSIC, getString(R.string.cat_music), R.drawable.ic_music, 0),
            ...
            CategoryEntry(ContentType.NEWSPAPER, getString(R.string.cat_newspaper), R.drawable.ic_newspaper, 0),
            CategoryEntry(ContentType.PRICE, getString(R.string.cat_price), R.drawable.ic_price, 0),
            CategoryEntry(ContentType.SERVICES, getString(R.string.cat_services), R.drawable.ic_services, 0),
